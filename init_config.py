...
# 全局变量
# 定位到本文件所在目录
__BASE_DIR__ = os.path.dirname(os.path.realpath(sys.argv[0]))
...
# 检查存不存在README.md文件，如果不存在，创建一个
if not os.path.exists(os.path.join(__BASE_DIR__, "README.md")):
    # 在mission文件夹中，生成md格式软件说明
    with open(os.path.join(__BASE_DIR__, "README.md"), "w") as f:
        f.write(
            """
## **软件功能**
